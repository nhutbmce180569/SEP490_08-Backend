...
public class TourAssistantController : LocalizedControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var result = await _personalizedService.RecommendFromProfileAsync(request, cancellationToken);
            return Ok(result);
        }
        catch (Exception ex)
        {
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var result = await _assistantService.ChatAsync(request.Message, request.SessionId, cancellationToken);
            return Ok(result);
        }
        catch (Exception ex)
        {
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var result = await _assistantService.ConsultAsync(request, cancellationToken);
            return Ok(result);
        }
        catch (Exception ex)
        {
